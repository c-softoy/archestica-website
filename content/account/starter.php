...
<jnlp spec="1.0+" codebase="http://archestica.net/jws">
	<information>
		<title>Archestica</title>
		<vendor>Sourceress Project</vendor>
		<homepage href="http://archestica.net"/>
...
Archestica is a fully fledged multiplayer online adventures game (MMORPG) developed using the Arianne game development system.
...
So what are you waiting for?! A whole new world awaits...</description>
	...
	<resources>
		...
		<jar href="https://archestica.net/jws/archestica-starter-0.51.jar" download="eager" main="true" />
	</resources>
	<application-desc>
